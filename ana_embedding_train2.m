...
% paths
if strcmp(monk,'yo')
    datadir = [parentdir '/P_neural_embed/Data_proc_13joint'];
    anadir = [parentdir '/P_neural_embed/embed_rhesus'];
else
    datadir = [parentdir '/P_neural_embed_wo/Data_proc_13joint'];
    anadir = [parentdir '/P_neural_embed_wo/embed_rhesus_useYoda'];
end
