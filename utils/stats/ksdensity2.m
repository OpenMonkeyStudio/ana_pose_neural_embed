...
% BV 5/4/2022: faster ksdensity
% https://undocumentedmatlab.com/articles/speeding-up-builtin-matlab-functions-part-3
...
if nargout>=4
    [fout,xout,u,plottype,ksinfo] = mvksdensity2(yData,xi,varargin{:});
else
    [fout,xout,u,plottype] = mvksdensity2(yData,xi,varargin{:});
end
