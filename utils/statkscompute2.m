function [fout,xout,u]=statkscompute2(ftype,xi,xispecified,m,u,L,U,weight,cutoff,...
...
[kernel,iscdf,kernelcutoff,kernelname,ftype] = statkskernelinfo2(ftype,kernelname,d);
